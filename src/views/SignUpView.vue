...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form class="space-y-6" @submit.prevent="signup">
      ...
      <div>
        <button type="submit" class="flex w-full justify-center rounded-md bg-[#fee1b7] px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-[#fee1b7] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">SIGN UP</button>
      </div>
    </form>
